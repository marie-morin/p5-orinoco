window.addEventListener("DOMContentLoaded", (event) => {
  ...
  if (!productsDestination || !priceDestination || !deleteDestination || !form)
    return;
      ...
      data.forEach((product) => {
        ...
        for (let i = 0; i < localStorage.length; i++) {
          ...
          if (localID == _id) {
            ...
            article.innerHTML = `<div class="product__showoff">
      ...
      form.addEventListener("submit", function (e) {
        ...
        if (products.length == 0) {
          productsDestination.innerHTML +=
            "<br><br><span class='attention'>Your cart must contain at least one product !</span>";
        } else {
